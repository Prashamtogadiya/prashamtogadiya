...
## 🔧 What I do now  
- I build full-stack applications using TypeScript and the MERN stack, focusing on scalability, clean architecture, and efficient API design. 
...
<div align="center">
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=prashamtogadiya&layout=compact&bg_color=111%2C082421%2C0D1117&title_color=7c60d1&text_color=f0f0f5&hide_border=true&border_radius=10&border_color=131313&hide=html,dart" alt="Top Languages" />
</div>

## ✨ I can help with

- Building scalable web applications using **TypeScript**, **React**, and **Node.js**  
- Designing clean API layers and backend systems with **Express** and **MongoDB**  
- Structuring reliable data models with **PostgreSQL** and **MySQL**  
- Developing maintainable frontend architectures with **Redux Toolkit**  
- Implementing **authentication**, **state management**, and **performance optimization**  
- Planning end-to-end **system design** for real-world scalability
